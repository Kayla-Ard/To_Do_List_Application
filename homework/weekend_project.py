...
def add_task(incomplete):                                                                           # defined a function for adding tasks that accepts user input
    ...
    if task not in incomplete:                                                                      # making sure the task user enters is not already on the incomplete_tasks list
        ...
        print(f"Your incomplete to-do list includes these tasks: {incomplete_tasks}.")              # prints messages to user showing them their current tasks on their list
        
def view_task(incomplete, complete):                                                                                # defined a function for viewing tasks that accepts user input
    task = input('Which to-do list would you like to view? Enter "1" for incomplete or enter "2" for complete: ')   # taking input from the user to see what type of tasks they would like to view
    if task == "1":                                                                                                 # created an if statement to see if user input is equal to 1
        for task in incomplete:                                                                                     # created a for loop to loop through incomplete_tasks list
            print("Here are your tasks in your incomplete to-do list: ")                                            # prints message to use letting them know the tasks being shown are in their incomplete to-do list
        ...
        for task in complete:                                                                                       # created a for loop to loop through completed_tasks list
            print("Here are your tasks in your completed to-do list: ")                                             # prints message to use letting them know the tasks being shown are in their completed to-do list
...
def mark_task(incomplete, complete):                                                                                        # defined a function for marking tasks complete that accepts user input
    task = input('To mark a task on your incomplete to-do list as "complete" enter "1" or enter "2" to return to Menu: ')   # taking input from the user to ensure they want to mark a task from incomplete_tasks list as completed 
    if task == "1":                                                                                                         # create an if statement to see if user input is equal to 1
        ...
        print(f"Your updated complete to-do list now includes these tasks: {completed_tasks}")                              # prints out an updated incomplete_tasks list for the user so they can see the changes 
...
def delete_task(incomplete, complete):                                                                                              # defined a function for deleting tasks that accepts user input
    ...
    if task == "1":                                                                                                                 # create an if statement to see if user input is equal to 1
        ...
        print(f"Your updated complete to-do list now includes these tasks: {completed_tasks}")                                      # removing the task that the user specified from the completed_tasks list
    else:                                                                                                                           # created an else statement to flag invalid user input
...
def app_run(incomplete, complete):                                                             # Defining a function with two parameters that displays a welcoming message and a menu with options for the user to choose from                                                                                                                   
    while True:                                                                                # Created a while loop in order to be able to run through the program multiple times until user instructs to end the program 
        response = input("""Welcome to the To-Do List App! \nPlease enter a number from the menu before for your desired selection.  
